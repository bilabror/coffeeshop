        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Produk Penukaran Poin</h4>
            </div>
            <div class="card-body">
              <form id="form">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img width="40%" id="blah" class="img-thumbnail" src="<?=base_url('uploads/image/produk_poin/'.$gambar_produk); ?>" alt="hero image">
                  </div>
                </div>
...
<?php $this->load->view('_layouts/js/produk_poin_edit'); ?>