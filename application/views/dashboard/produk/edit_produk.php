            ...
            <div class="card-body">
              <form id="form">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label class="col-form-label" for="id_kategori">Kaegori</label>
                    <select class="form-control" name="id_kategori">
                      <option value="0" class="pilih-kategori">--- PILIH KATEGORI ---</option>
                    </select>
                    <div class="invalid-feedback" in="id_kategori"></div>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col">
                    <label class="col-form-label" for="stock">Stok</label>
                    <input type="number" class="form-control" id="stok_produk" name="stok_produk"
                    placeholder="0" value="<?= set_value('stok_produk') ?>" />
                    <div class="invalid-feedback" in="stok_produk"></div>
                  </div>
                  <div class="form-group col">
                    <label class="col-form-label" for="weight">Berat</label>
                ...
                <div class="form-row">
                  <div class="form-group col-md-5">
                    <label class="col-form-label" for="harga_produk">Price Rp.</label>
                    <input type="number" class="form-control" id="harga_produk" name="harga_produk"
                    placeholder="Before Discount" value="<?= set_value('harga_produk') ?>" onkeyup="discount()" />
                    <div class="invalid-feedback" in="harga_produk"></div>
                  </div>
                  <div class="form-group col-md-2">
                    <label class="col-form-label" for="diskon_produk">Discount %</label>
                    <input type="number" data-toggle="tooltip"
                    title="Enter '0' if you don't have a discount" class="form-control"
                    id="diskon_produk" name="diskon_produk" placeholder="%" onkeyup="discount()" />
                    <div class="invalid-feedback" in="diskon_produk"></div>
                  </div>
                  <div class="form-group col-md-5">
                    <label class="col-form-label" for="total_harga_produk">Price Total Rp.</label>
                    <input type="number" class="form-control" readonly="" id="total_harga_produk"
                    name="total_harga_produk" placeholder="After discount"
                    value="<?= set_value('total_harga_produk') ?>" />
                    <div class="invalid-feedback" in="total_harga_produk"></div>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img width="40%" id="blah" class="img-thumbnail" src="<?=base_url('uploads/image/produk/'.$gambar_produk); ?>" alt="hero image">
                  </div>
                </div>
...
<?php $this->load->view('_layouts/js/produk_edit_js'); ?>