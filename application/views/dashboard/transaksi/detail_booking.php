              ...
              <div class="row">
                ...
                <div class="col-md-6 text-md-right">
                  <address>
                    ...
                    <strong>Pembookingan:</strong><br>
                    NO MEJA<?= $booking->no_meja ?> <br> <?= date('Y-m-d H:i', strtotime($booking->prk_datang)) ?><br>
                  </address>
                </div>
              </div>
            </div>
    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.status == false) {
          ...
          window.location.href = "<?=site_url('dashboard/transaksi/booking') ?>";
        }
      },
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer bg-whitesmoke br">
          ...
          <button type="button" onclick="save()" class="btn btn-primary" id="btnsave">SIMPAN</button>
        </div>
      </form>
    </div>
  </div>
