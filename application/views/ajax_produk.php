    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text mt-2">
          ...
          <?php else : ?>
          <a class="cart btn w-100 text-white mt-3"data-bs-toggle="offcanvas" href="#offcanvasBottom" role="button" aria-controls="offcanvasExample" onclick="get_produk_id(<?=$produk->id_produk ?>)">
